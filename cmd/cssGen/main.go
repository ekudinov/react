...
var attrs = map[string]typ{
	...
	"Display":         typ{"display", "string"},
	"Float":           typ{"float", "string"},
	"Clear":           typ{"clear", "string"},
	"ListStyle":       typ{"listStyle", "string"},
	"Background":      typ{"background", "string"},
	"Color":           typ{"color", "string"},
	"Border":          typ{"border", "string"},
	"Padding":         typ{"padding", "string"},
	"Margin":          typ{"margin", "string"},
	"FontWeight":      typ{"fontWeight", "string"},
	"BackgroundColor": typ{"backgroundColor", "string"},
}
